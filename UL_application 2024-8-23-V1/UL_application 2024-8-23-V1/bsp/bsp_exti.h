...
#ifdef USER_DEBUG
#define EXTI_DEBUG_EN	1		/* 0: non-DEBUG state, 1: DEBUG status */
#else
...
#define ALARM_GPIO_CLK_ENABLE()           rcu_periph_clock_enable(RCU_GPIOB);
#define ALARM_INT_GPIO_PIN                GPIO_PIN_14  
#define ALARM_READ  	  	              gpio_input_bit_get(GPIOB,GPIO_PIN_14)
