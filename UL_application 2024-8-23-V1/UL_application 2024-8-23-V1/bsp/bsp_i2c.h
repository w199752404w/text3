...
#define I2C_TIMEOUT   100			                                                              //5ms timeout

/* Define macros for reading and writing SCL and SDA */
#define IIC_SCL_PORT   GPIOB
#define IIC_SDA_PORT   GPIOB
#define SCL_PIN        GPIO_PIN_6                                                          //Simulate the SCL signal of IIC 
#define SDA_PIN        GPIO_PIN_7                                                          //Simulate the SDA signal of IIC
...
uint8_t i2c_SendByte1(uint8_t Send_Byte);
