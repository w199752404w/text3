...
#define POWER_ON_12V_VDD_H      gpio_bit_set(GPIOB,GPIO_PIN_3)
#define POWER_ON_12V_VDD_L      gpio_bit_reset(GPIOB,GPIO_PIN_3)
#define CAN_RES_ON              gpio_bit_reset(GPIOA,GPIO_PIN_8)
#define CAN_RES_OFF             gpio_bit_set(GPIOA,GPIO_PIN_8)
//AFE的IO操作函数
#define AFE_CTLD_H	            gpio_bit_set(GPIOB,GPIO_PIN_1)
#define AFE_CTLD_L	            gpio_bit_reset(GPIOB,GPIO_PIN_1)
#define AFE_CHGD_H	            gpio_bit_set(GPIOC,GPIO_PIN_8)          //AFE唤醒，拉低
#define AFE_CHGD_L	            gpio_bit_reset(GPIOC,GPIO_PIN_8)
...
//485的IO操作函数
#define E485_CTL_1_H  		    gpio_bit_set(GPIOA,GPIO_PIN_10)
#define E485_CTL_1_L  		    gpio_bit_reset(GPIOA,GPIO_PIN_10)


//自动编码IO口操作函数
#define CODE_OP_IN_READ  	  	gpio_input_bit_get(GPIOA,GPIO_PIN_9)
#define CODE_OP_IN_H            gpio_bit_set(GPIOA,GPIO_PIN_9)
#define CODE_OP_IN_L            gpio_bit_reset(GPIOA,GPIO_PIN_9)
#define CODE_OUT_READ  	        gpio_input_bit_get(GPIOC,GPIO_PIN_0)
#define CODE_OUT_H              gpio_bit_set(GPIOC,GPIO_PIN_0)
#define CODE_OUT_L              gpio_bit_reset(GPIOC,GPIO_PIN_0)
