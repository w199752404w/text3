...
//	g_stCfg.stLocal.ucSVerRMinor = 0;
	...
	g_stCfg.stLocal.ausSocECaliU[0] = 2800;  //10%  demarcate
	g_stCfg.stLocal.ausSocECaliU[1] = 2500;  //5%   demarcate
	g_stCfg.stLocal.ausSocECaliU[2] = 2400;  //0%   demarcate
	...
	g_stCfg.stLocal.usCellUVTVThr1 = 2250;
	g_stCfg.stLocal.usCellUVTTThr1 = 3000;
	g_stCfg.stLocal.usCellUVRVThr1 = 2700;
	g_stCfg.stLocal.usCellUVRTThr1 = 0;
	g_stCfg.stLocal.usCellUVTVThr2 = 2350;
...
//		}
	...
	g_stCfg.stLocal.ucSVerRMinor = 5;//电池容量型号变化
