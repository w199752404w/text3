...
//			HIS_DATA_S stDataaaa = {0};
//			his_data_read(i,&stDataaaa);
//			for(uint16_t i=0;i<256;i++) {
//				uint16_t usRet = 0;
//				memcpy(&usRet, (uint8_t*)&stDataaaa + i * sizeof(uint16_t), sizeof(uint16_t));
//				g_aucCanSBuf[i * 2] = usRet >> 8;
//				g_aucCanSBuf[i * 2 + 1] = usRet & 0xFF;
//			}
//			eco_can_data_send(1, 0, 0x51, 0, g_aucCanSBuf, 256 * sizeof(uint16_t));
//		}
//	}
	while(1) {
	  WDG_DONE_H;
