#ifndef __BSP_GD25Q32_H
#define __BSP_GD25Q32_H
#include "gd32f10x.h"
#include "stdbool.h"
#include "stdint.h"
...
#define  ADDRESS_MAX                            0x3fffff  /* 36M Bit */
...
//#define SPI_WP_LOW         	gpio_bit_reset(GPIOC,GPIO_PIN_4)
#define SPI_HOLD_HIGH       gpio_bit_set(GPIOC,GPIO_PIN_9)
...
static uint8_t Flash_PageWrite(uint8_t* tBuf, uint32_t tWriteAddr, uint16_t tNum);
static void Flash_Write_NoCheck(uint8_t* pBuffer, uint32_t WriteAddr, uint32_t NumByteToWrite);
