...
bool cfg_set_default(void) {
	...
	g_stCfg.stAfe.aucRomByte[15] = 0xBF;	/* т╜1000A 0x5F ож2000A */ /* SC , 250,400,550,700,850,1000,1150,1300,1450,1600,1750,2000,2500,3000,4000,5000A;0,64,128,192,256,320,384,448,512,576,640,704,768,832,896,960us */
...
//	g_stCfg.stLocal.ucSVerRMinor = 0;
	...
	g_stCfg.stLocal.sCellUCTRVThr1 = 0;
...
//		}
	...
	g_stCfg.stLocal.ucSVerRMajor = 0;
	g_stCfg.stLocal.ucSVerRMinor = 3;
